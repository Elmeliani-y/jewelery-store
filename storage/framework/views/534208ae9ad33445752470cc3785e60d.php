<?php $__env->startSection('title'); ?> تفاصيل المبيعة <?php $__env->stopSection(); ?>
...
<div class="container-fluid">
    <div class="sale-header d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3">
        <div class="d-flex flex-column gap-1">
            <h4 class="mb-0"><i class="mdi mdi-file-document-outline me-1"></i> الفاتورة رقم <span class="text-mono"><?php echo e($sale->invoice_number); ?></span></h4>
            <span class="opacity-75">تفاصيل العملية ومكوناتها بشكل منسق</span>
        </div>
        <div class="sale-meta d-flex flex-wrap gap-2">
            <span class="badge bg-primary-subtle text-primary"><i class="mdi mdi-storefront-outline me-1"></i> <?php echo e($sale->branch->name); ?></span>
            <span class="badge bg-info-subtle text-info"><i class="mdi mdi-account-outline me-1"></i> <?php echo e($sale->employee->name); ?></span>
            <?php if(count($productsArray) > 0): ?>
            <span class="badge bg-success-subtle text-success"><i class="mdi mdi-package-variant-closed me-1"></i> <?php echo e(count($productsArray)); ?> منتج</span>
            <?php endif; ?>
            ...
            <div class="row g-3 mb-1">
                <div class="col-6 col-md-3">
                    <div class="metric-card h-100">
                        ...
                        <div class="value-lg"><?php echo e(number_format($sale->weight,2)); ?></div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="metric-card h-100">
                        ...
                        <div class="value-lg text-mono" dir="ltr"><?php echo e(number_format($sale->total_amount,2)); ?></div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="metric-card h-100">
                        ...
                        <div class="value-lg"><?php echo e($sale->created_at->format('Y-m-d')); ?></div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="metric-card h-100">
                        ...
                        <div class="value-lg"><?php echo e($sale->updated_at->format('Y-m-d H:i')); ?></div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-sm mb-0 align-middle">
                            ...
                            <tbody class="fs-13">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($product['caliber_name'] ?? ''); ?></td>
                                    <td><?php echo e(number_format($product['weight'] ?? 0, 2)); ?></td>
                                    <td class="text-mono" dir="ltr"><?php echo e(number_format($product['amount'] ?? 0, 2)); ?></td>
                                    <td class="text-mono" dir="ltr"><?php echo e(number_format($product['tax_amount'] ?? 0, 0, ',', '.')); ?></td>
                                    <td class="text-mono" dir="ltr"><?php echo e(number_format($product['net_amount'] ?? 0, 0, ',', '.')); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <tr class="table-secondary fw-semibold">
                                    <td colspan="3" class="text-end">المجموع:</td>
                                    <td><?php echo e(number_format($sale->weight, 2)); ?></td>
                                    <td class="text-mono" dir="ltr"><?php echo e(number_format($sale->total_amount, 2)); ?></td>
                                    <td class="text-mono" dir="ltr"><?php echo e(number_format($sale->tax_amount, 0, ',', '.')); ?></td>
                                    <td class="text-mono" dir="ltr"><?php echo e(number_format($sale->net_amount, 0, ',', '.')); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table table-sm mb-0 detail-table align-middle">
                            ...
                            <tbody class="fs-13">
                                <tr>
                                    ...
                                    <td class="fw-semibold text-mono" dir="ltr"><?php echo e($sale->id); ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($sale->caliber->name); ?></td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                ...
                                <?php if($sale->payment_method === 'mixed'): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-mono fw-semibold text-success" dir="ltr"><?php echo e(number_format($sale->cash_amount,2)); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted ps-4">
                                        <i class="mdi mdi-credit-card-outline text-info me-1"></i>مبلغ الشبكة
                                    </td>
                                    <td class="text-mono fw-semibold text-info" dir="ltr"><?php echo e(number_format($sale->network_amount,2)); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted ps-4">
                                        <i class="mdi mdi-calculator me-1"></i>المجموع
                                    </td>
                                    <td class="text-mono fw-bold" dir="ltr"><?php echo e(number_format($sale->cash_amount + $sale->network_amount,2)); ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($sale->updated_at->format('Y-m-d H:i')); ?></td>
                                </tr>
                                <tr>
                    ...
                    <ul class="timeline mb-0">
                        <li class="timeline-item">
                            ...
                            <div class="ms-4">
                                ...
                                <small class="text-muted"><?php echo e($sale->created_at->diffForHumans()); ?> • <?php echo e($sale->created_at->format('Y-m-d H:i')); ?></small>
                            </div>
                        </li>
                        <li class="timeline-item">
                            ...
                            <div class="ms-4">
                                ...
                                <small class="text-muted"><?php echo e($sale->updated_at->diffForHumans()); ?> • <?php echo e($sale->updated_at->format('Y-m-d H:i')); ?></small>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body d-flex flex-wrap gap-2">
                    <?php if(!auth()->user()->isBranch()): ?>
                        <a href="<?php echo e(route('t6u1v5w8.edit', $sale)); ?>" class="btn btn-warning btn-sm"><i class="mdi mdi-pencil-outline me-1"></i> تعديل</a>
                    ...
                    <?php endif; ?>
                    <?php if(auth()->user()->isBranch()): ?>
                        <a href="<?php echo e(url('/branch/daily-sales')); ?>" class="btn btn-secondary btn-sm"><i class="mdi mdi-arrow-left me-1"></i> رجوع للقائمة اليومية</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('t6u1v5w8.index')); ?>" class="btn btn-secondary btn-sm"><i class="mdi mdi-arrow-left me-1"></i> رجوع للقائمة</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.vertical', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Dusty_Laravel_v1.0.0\Dusty\resources\views/sales/show.blade.php ENDPATH**/ ?>