...
<div class="d-flex justify-content-between align-items-center mb-3 report-toolbar">
  <div class="d-flex align-items-center gap-2">
    ...
    <?php if(!empty($filters['date_from']) || !empty($filters['date_to'])): ?>
      <span class="badge bg-light text-muted border small">من <?php echo e($filters['date_from'] ?? '-'); ?> إلى <?php echo e($filters['date_to'] ?? '-'); ?></span>
    <?php endif; ?>
  </div>
  <div class="d-flex align-items-center">
    <a href="<?php echo e($backUrl ?? route('t3u8v1w4.b1c5d8e3')); ?>" class="btn btn-light btn-sm" title="الرجوع"><iconify-icon icon="solar:arrow-right-bold"></iconify-icon></a>
    <div class="btn-group ms-2">
      <button type="button" class="btn btn-outline-secondary btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <iconify-icon icon="solar:export-bold" class="me-1"></iconify-icon> تصدير
      </button>
      <ul class="dropdown-menu dropdown-menu-end">
        <li><button type="button" class="dropdown-item" onclick="window.exportTablesAsCsv('<?php echo e($exportFilename); ?>')">CSV</button></li>
...
<?php if (! $__env->hasRenderedOnce('8084b3d8-42f7-4717-97fd-9f668437fa5b')): $__env->markAsRenderedOnce('8084b3d8-42f7-4717-97fd-9f668437fa5b'); ?>
<script>
(() => {
...
<?php endif; ?>
<?php /**PATH C:\Dusty_Laravel_v1.0.0\Dusty\resources\views/reports/partials/toolbar.blade.php ENDPATH**/ ?>