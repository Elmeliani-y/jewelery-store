...
<div class="container-fluid">
    ...
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div>
            <a href="<?php echo e(route('d7e1f5g9.create')); ?>" class="btn btn-light">
                ...
                <div class="user-card p-3 h-100 d-flex flex-column">
                    ...
                    <div class="mt-3 flex-grow-1">
                        ...
                        <div class="d-flex justify-content-between mb-2 stats-small">
                            <span>الفرع:</span>
                            <strong><?php echo e($user->branch?->name ?? '-'); ?></strong>
                        </div>
                        <div class="text-muted small">📅 <?php echo e($user->created_at->format('Y-m-d')); ?></div>
                    </div>

                    <div class="mt-3 d-flex gap-2">
                        <a href="<?php echo e(route('d7e1f5g9.show', $user)); ?>" class="btn btn-secondary btn-sm flex-fill">
                            <iconify-icon icon="solar:eye-bold" class="me-1"></iconify-icon>عرض
                        </a>
                        <a href="<?php echo e(route('d7e1f5g9.edit', $user)); ?>" class="btn btn-primary btn-sm flex-fill">
                            <iconify-icon icon="solar:pen-bold" class="me-1"></iconify-icon>تعديل
                        </a>
                        <?php if($user->id !== auth()->id()): ?>
                        <form action="<?php echo e(route('d7e1f5g9.destroy', $user)); ?>" method="POST" class="flex-fill delete-form">
                            <?php echo csrf_field(); ?>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-12">
                <div class="text-center py-5">
                    ...
                    <a href="<?php echo e(route('d7e1f5g9.create')); ?>" class="btn btn-primary mt-2">
...
<?php echo $__env->make('layouts.vertical', ['title' => 'إدارة المستخدمين'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Dusty_Laravel_v1.0.0\Dusty\resources\views/users/index.blade.php ENDPATH**/ ?>