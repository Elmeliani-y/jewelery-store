<?php $__env->startSection('title','إدارة الأصناف'); ?>
...
<div class="container-fluid">
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        <i class="mdi mdi-alert-circle me-2"></i><?php echo e(session('error')); ?>
    ...
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div>
            <a href="<?php echo e(route('v5w9x4y1.create')); ?>" class="btn btn-light">
        ...
        <div class="col-md-6 col-lg-4 mb-3">
            <div class="category-card card h-100">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <small class="text-muted d-block">عدد المبيعات: <?php echo e($category->sales_count); ?></small>
                        <?php if($category->defaultCaliber): ?>
                            <small class="text-muted d-block mt-1">
                                <iconify-icon icon="solar:medal-star-bold-duotone" class="text-warning"></iconify-icon>
                                العيار الافتراضي: <strong><?php echo e($category->defaultCaliber->name); ?></strong>
                            </small>
                        <?php else: ?>
                            <small class="text-muted d-block mt-1">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('v5w9x4y1.edit', $category)); ?>" class="btn btn-sm btn-primary flex-fill">
                            <iconify-icon icon="solar:pen-bold"></iconify-icon> تعديل
                        </a>
                        <form action="<?php echo e(route('v5w9x4y1.destroy', $category)); ?>" method="POST" class="flex-fill" onsubmit="return confirm('هل أنت متأكد من حذف هذا الصنف؟')">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'إدارة الأصناف'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Dusty_Laravel_v1.0.0\Dusty\resources\views/categories/index.blade.php ENDPATH**/ ?>