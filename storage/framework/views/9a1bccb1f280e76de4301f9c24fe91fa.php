<?php $__env->startSection('title', 'تقرير صافي الربح'); ?>
...
<div class="container-fluid">
    ...
    <div class="card mb-3 kasr-filters-form">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('t3u8v1w4.t6u2v8w5')); ?>" id="kasrForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-3 mb-4 pb-3 border-bottom">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="date_from" id="date_from" 
                               value="<?php echo e(request('date_from', $filters['date_from'] ?? date('Y-m-01'))); ?>" 
                               class="form-control"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="date_to" id="date_to" 
                               value="<?php echo e(request('date_to', $filters['date_to'] ?? date('Y-m-d'))); ?>" 
                               class="form-control"
                               onchange="submitKasrFilters()">
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="branch_id" id="branch_id" class="form-select" onchange="submitKasrFilters()">
                            ...
                            <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($branch->id); ?>" 
                                    <?php echo e(request('branch_id', $filters['branch_id'] ?? '') == $branch->id ? 'selected' : ''); ?>>
                ...
                <div class="table-responsive">
                    <table class="kasr-table table">
                        ...
                        <tbody>
                        <?php $__currentLoopData = $reportData['calibers'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $caliber): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="caliber-label text-end"><?php echo e($caliber['name']); ?></td>
                                <td>
                                     <input type="number" value="<?php echo e($caliber['weight'] ?? 0); ?>" step="0.01" class="form-control" disabled>
                                </td>
                                <td>
                                    <?php
                                    ...
                                    ?>
                                    <input type="number" name="<?php echo e($inputName); ?>" value="<?php echo e($inputValue); ?>" step="0.01" class="form-control" autocomplete="off">
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-6">
                        ...
                        <select name="expenses_select" id="expenses_select" class="form-select mb-2">
                                                        ...
                                                        ?>
                                                        <option value="<?php echo e($expensesSum); ?>" <?php echo e((request('expenses_select', $expensesSum) == $expensesSum) ? 'selected' : ''); ?>>المجموع: <?php echo e(number_format($expensesSum, 2)); ?></option>
                                                        <option value="custom" <?php echo e((request('expenses_select') == 'custom') ? 'selected' : ''); ?>>أدخل قيمة يدوياً</option>
                        </select>
                        <input type="number" step="0.01" name="expenses" id="expenses_input" class="form-control" style="display:none;" value="<?php echo e(request('expenses', '')); ?>" placeholder="أدخل المصروفات يدوياً">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="salaries_select" id="salaries_select" class="form-select mb-2">
                            <option value="<?php echo e($salariesSum); ?>" <?php echo e((request('salaries_select', $salariesSum) == $salariesSum) ? 'selected' : ''); ?>>المجموع: <?php echo e(number_format($salariesSum, 2)); ?></option>
                            <option value="custom" <?php echo e((request('salaries_select') == 'custom') ? 'selected' : ''); ?>>أدخل قيمة يدوياً</option>
                        </select>
                        <input type="number" step="0.01" name="salaries" id="salaries_input" class="form-control" style="display:none;" value="<?php echo e(request('salaries', '')); ?>" placeholder="أدخل الرواتب يدوياً">
                    ...
                    <div class="col-md-6">
                        <label for="interest_rate" class="form-label fw-semibold">قيمة الفائدة</label>
                                           <input type="number" name="interest_rate" id="interest_rate"
                                               value="<?php echo e(old('interest_rate', $filters['interest_value'] ?? 0)); ?>"
...
(function() {
    ...
    let totalAmount = 0;
    <?php if(isset($reportData['total_amount'])): ?>
        totalAmount = <?php echo e(floatval($reportData['total_amount'])); ?>;
    <?php endif; ?>
    ...
    <div class="kasr-receipt mt-3" style="width:100%; max-width:700px; margin:0 auto; background:linear-gradient(135deg,#f8fafc 60%,#e0e7ef 100%); box-shadow:0 6px 32px rgba(0,0,0,0.10); border-radius:18px; padding:32px 28px 18px 28px;">
        ...
        <div class="kasr-grid-2by2" style="margin-bottom:18px;">
            <div>
                ...
                <div style="font-size:1.2rem;color:#222;font-weight:700;"><?php echo e($selectedBranch->name ?? '-'); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">الفترة</div>
                <div style="font-size:1.2rem;color:#222;font-weight:700;"><?php echo e($filters['date_from'] ?? '-'); ?> إلى <?php echo e($filters['date_to'] ?? '-'); ?></div>
            </div>
        </div>
        <div class="kasr-grid-2by2" style="margin-bottom:18px;">
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">المصروفات</div>
                <div style="font-size:1.2rem;color:#e11d48;font-weight:700;" id="receipt_expenses"><?php echo e(number_format($reportData['expenses'] ?? $expenses ?? 0, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">الرواتب</div>
                <div style="font-size:1.2rem;color:#eab308;font-weight:700;" id="receipt_salaries"><?php echo e(number_format($reportData['salaries'] ?? $salaries ?? 0, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">قيمة الفائدة</div>
                <div style="font-size:1.2rem;color:#0ea5e9;font-weight:700;" id="receipt_interest_rate"><?php echo e(number_format($reportData['interest_value'] ?? $filters['interest_value'] ?? 0, 2)); ?></div>
            </div>
        </div>
        ...
        <div class="kasr-grid-2by2" style="margin-bottom:18px;">
            <div>
                ...
                <div style="font-size:1.2rem;color:#16a34a;font-weight:700;"><?php echo e(number_format($reportData['total_sales_and_returns'] ?? 0, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">قيمة المرتجع</div>
                <div style="font-size:1.2rem;color:#e11d48;font-weight:700;"><?php echo e(number_format($reportData['total_returns'] ?? 0, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">مجموع الضريبة</div>
                <div style="font-size:1.2rem;color:#0ea5e9;font-weight:700;"><?php echo e(number_format($reportData['total_tax'] ?? 0, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">الإجمالي (صافي المبيعات + الضريبة)</div>
                <div style="font-size:1.2rem;color:#6366f1;font-weight:700;"><?php echo e(number_format(($reportData['net_sales'] ?? 0) + ($reportData['total_tax'] ?? 0), 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">صافي المبيعات</div>
                <div style="font-size:1.2rem;color:#16a34a;font-weight:700;"><?php echo e(number_format($reportData['net_sales'] ?? 0, 2)); ?></div>
            </div>
        </div>
        <div style="border-top:1.5px dashed #cbd5e1;margin:18px 0 18px 0;"></div>
        <div class="kasr-grid-2by2" style="margin-bottom:18px;">
            <div>
                ...
                <div style="font-size:1.2rem;color:#0ea5e9;font-weight:700;"><?php echo e(number_format(($reportData['total_weight'] ?? 0) + ($reportData['total_weight_returns'] ?? 0), 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">وزن المرتجع</div>
                <div style="font-size:1.2rem;color:#e11d48;font-weight:700;"><?php echo e(number_format($reportData['total_weight_returns'] ?? 0, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">معدل الجرام (صافي المبيعات ÷ صافي الوزن)</div>
                <div style="font-size:1.2rem;color:#6366f1;font-weight:700;"><?php echo e(number_format($reportData['avg_price_per_gram'] ?? 0, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">سعر الجرام (الإجمالي ÷ صافي الوزن)</div>
                <div style="font-size:1.2rem;color:#6366f1;font-weight:700;"><?php echo e(number_format($reportData['price_of_gram'] ?? 0, 2)); ?></div>
            </div>
        </div>
        <?php if(isset($reportData['calibers']) && is_array($reportData['calibers'])): ?>
        <div style="border-top:1.5px dashed #cbd5e1;margin:18px 0 18px 0;"></div>
        <div style="margin-bottom:18px;">
            ...
            <div class="calibers-2by2-grid">
                ...
                <?php for($i = 0; $i < $rows * $cols; $i++): ?>
                    <?php if($i < $count): ?>
                        <?php $caliber = $caliberCards[$i]; ?>
                        <div class="caliber-card" style="background:#fff;border-radius:12px;box-shadow:0 2px 8px #e0e7ef;padding:18px 16px;">
                            <div style="font-size:1.1rem;color:#6366f1;font-weight:700;margin-bottom:6px;"><i class="mdi mdi-gold"></i> <?php echo e($caliber['name']); ?></div>
                            <div style="font-size:1.05rem;color:#64748b;font-weight:600;">مبيعات بدون ضريبة</div>
                            <div style="font-size:1.2rem;color:#16a34a;font-weight:700;"><?php echo e(number_format($caliber['cash'] ?? 0, 2)); ?></div>
                            <div style="font-size:1.05rem;color:#64748b;font-weight:600;">ذهب (وزن)</div>
                            <div style="font-size:1.2rem;color:#eab308;font-weight:700;"><?php echo e(number_format($caliber['weight'], 2)); ?></div>
                            <div style="font-size:1.05rem;color:#64748b;font-weight:600;">معدل الجرام</div>
                            <div style="font-size:1.2rem;color:#0ea5e9;font-weight:700;"><?php echo e(number_format($caliber['avg_price_per_gram'] ?? 0, 2)); ?></div>
                        </div>
                    <?php else: ?>
        ...
        <div class="kasr-grid-2by2" style="margin-bottom:18px;">
            <div>
                ...
                <div style="font-size:1.2rem;color:#0ea5e9;font-weight:700;" id="receipt_profit"><?php echo e(number_format($final_faida, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">صافي الربح</div>
                <div style="font-size:1.2rem;color:#16a34a;font-weight:700;" id="receipt_net_profit"><?php echo e(number_format($safi, 2)); ?></div>
            </div>
            <div>
                <div style="font-size:1.1rem;color:#64748b;font-weight:600;">سعر الجرام بفائدة</div>
                <div style="font-size:1.2rem;color:#e11d48;font-weight:700;"><?php echo e($gramWithFaida); ?></div>
            </div>
        </div>
        <div class="muted text-center mt-2" style="font-size:1.1rem;"><?php echo e(\Carbon\Carbon::now()->format('l, F d, Y')); ?></div>
    </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>   
<?php echo $__env->make('layouts.vertical', ['title' => 'تقرير صافي الربح'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Dusty_Laravel_v1.0.0\Dusty\resources\views/reports/kasr.blade.php ENDPATH**/ ?>