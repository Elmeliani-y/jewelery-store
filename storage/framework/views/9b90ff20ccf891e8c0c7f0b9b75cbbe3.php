<?php $__env->startSection('title'); ?> قائمة المرتجعات <?php $__env->stopSection(); ?>
                ...
                <div class="card-body p-0">
                    ...
                    <form method="GET" class="mb-3 row g-2 align-items-end">
                        <div class="col-md-2">
                            ...
                            <select name="branch_id" id="branch_id" class="form-select">
                                ...
                                <?php $__currentLoopData = App\Models\Branch::active()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="table-responsive table-card sales-table">
                        <table class="table table-borderless table-centered align-middle table-nowrap table-hover mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><span class="badge bg-danger-subtle text-danger"><?php echo e($sale->id); ?></span></td>
                                    ...
                                    <td dir="ltr">
                                        ...
                                        ?>
                                        <span class="fw-semibold text-dark"><?php echo e(number_format($pricePerGram, 2)); ?></span>
                                    </td>
                                    <td dir="ltr"><span class="fw-semibold text-dark"><?php echo e(number_format($sale->total_amount, 0, ',', '.')); ?> <small class="text-muted">ريال</small></span></td>
                                    <td class="text-muted"><?php echo e($sale->returned_at ? $sale->returned_at->format('Y-m-d') : '-'); ?></td>
                                    <td class="text-center sales-table-actions">
                                        ...
                                        <button type="button" class="btn btn-icon btn-sm bg-success-subtle ms-1 btn-unreturn-sale" data-sale-id="<?php echo e($sale->id); ?>" data-url="<?php echo e(route('t6u1v5w8.b4c8d1e5', $sale)); ?>" data-bs-toggle="tooltip" data-bs-original-title="إرجاع كعملية بيع">
                            ...
                            <tfoot class="table-light">
                                <tr class="fw-semibold">
                                    ...
                                    <td class="text-end"><?php echo e(number_format($returns->sum('weight'), 2)); ?></td>
                                    <td></td>
                                    <td class="text-end"><?php echo e(number_format($returns->sum('total_amount'), 2)); ?></td>
                                    <td class="text-end">عدد المرتجعات: <?php echo e($returns->count()); ?></td>
                                    <td></td>
                                </tr>
                            </tfoot>
                        </table>
                    ...
                    <div class="p-3 border-top d-flex flex-column flex-sm-row justify-content-between align-items-center gap-2">
                        <div class="d-flex flex-column flex-md-row align-items-center gap-2">
                            <small class="text-muted">
                                عرض <?php echo e($returns->firstItem()); ?>–<?php echo e($returns->lastItem()); ?> من أصل <?php echo e($returns->total()); ?>
...
<?php echo $__env->make('layouts.vertical', ['title' => 'قائمة المرتجعات'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Dusty_Laravel_v1.0.0\Dusty\resources\views/sales/returns.blade.php ENDPATH**/ ?>