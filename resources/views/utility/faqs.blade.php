                ...
                <div class="accordion-item accordion-item-faq shadow-sm">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body pb-0">
                            <p class="mb-0 text-muted">Yes, our platforms come in various sizes and configurations, making them suitable for practices of all sizes, from small clinics to large hospital systems.</p>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    <ul class="list-unstyled users-list d-flex align-items-center avatar-group m-0 me-2">
                                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar-sm pull-up" aria-label="Vinnie Mostowy" data-bs-original-title="Vinnie Mostowy">
                                            <img class="rounded-circle img-fluid border border-2" src="/images/users/user-5.jpg" alt="avatar">
                                        </li>
                                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar-sm pull-up" aria-label="Allen Rieske" data-bs-original-title="Allen Rieske">
                                            <img class="rounded-circle img-fluid border border-2" src="/images/users/user-9.jpg" alt="avatar">
                                        </li>
                                        <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar-sm pull-up" aria-label="Julee Rossignol" data-bs-original-title="Julee Rossignol">
                                            <img class="rounded-circle img-fluid border border-2" src="/images/users/user-8.jpg" alt="avatar">
                                        </li>
                                    </ul>
                                </div>
                            </li>
