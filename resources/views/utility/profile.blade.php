                                    ...
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <ol class="profile-section list-unstyled mb-md-0 px-4">
                                            ...
                                            <li class="profile-item">
                                                ...
                                                <div class="exper-item-list">
                                                    <div>
                                                        <h5 class="fs-16 text-dark mb-1">VP, Product Management</h5>
                                                        <div class="list-inline list-inline-dots mb-1 fs-14">
                                            ...
                                            <li class="profile-item pb-0">
                                                ...
                                                <div class="exper-item-list">        
                                                    <h5 class="fs-16 text-dark mb-1">Director, Product Management</h5>
                                                    <div class="list-inline list-inline-dots mb-1 fs-14">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-lg-6">
                                        <ol class="profile-section list-unstyled mb-0 px-4">
                                            ...
                                            <li class="profile-item">
                                                ...
                                                <div class="exper-item-list">
                                                    <h5 class="fs-16 text-dark mb-1">Mobile Developer & Algo Expert</h5>
                                                    <div class="list-inline list-inline-dots mb-1 fs-14">
                                            ...
                                            <li class="profile-item pb-0">
                                                ...
                                                <div class="exper-item-list">
                                                    <h5 class="fs-16 text-dark mb-1">UI /UX Designer</h5>
                                                    <div class="list-inline list-inline-dots mb-1 fs-14">
