...
<div class="container-fluid">
    ...
    <form action="{{ route('f3g8h1i4.store') }}" method="POST">@csrf
        <div class="row">
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('f3g8h1i4.index') }}" class="btn btn-light btn-lg"><iconify-icon icon="solar:close-circle-bold" class="me-1"></iconify-icon> إلغاء</a>
                </div>
            </div>
        </div>
    </form>
