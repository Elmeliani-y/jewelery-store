@extends('layouts.auth', ['title' => 'Email Confirmation'])
                    ...
                    <div class="mb-0 p-0 p-lg-3">
                        <div class="mb-0 border-0 p-md-4 p-lg-0">
                            ...
                            <div class="auth-title-section text-center">
                                <h3 class="text-primary fw-semibold mb-1">Email Confirmation</h3>
                                <p class="text-muted fs-14 mb-0">Please check your email for confirmation mail</p>
                            </div>
                            ...
                            <div class="text-center">
                                <a href="#" class="btn btn-primary" type="submit">Resend Confirmation</a>
                            </div>
