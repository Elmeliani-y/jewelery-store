        ...
        <div class="card overflow-hidden text-center">
            <div class="card-body">
                ...
                <div class="text-center">
                    <h3 class="fw-semibold text-primary lh-base">Too many requests</h3>
                    <h4 class="fw-semibold mt-2 text-dark lh-base fs-18">Something's Missing.....! Too Many Requests</h4>
                    <p class="text-muted text-center mb-0">This pages you are trying to access does not exits or has been moved. <br> Try going back to our homepage.</p>
